  ...
  useEffect(() => {
    ...
    class CarLights {
      ...
      init() {
        ...
        for (let i = 0; i < options.lightPairsPerRoadWay; i++) {
          ...
          const color: any = pickRandom(colors);
          aColor.push(color.r);
          aColor.push(color.g);
          aColor.push(color.b);
    ...
    class App {
      ...
      constructor(container: HTMLElement, options: any = {}) {
        ...
        this.init = this.initFn.bind(this);
        this.setSize = this.setSizeFn.bind(this);
        this.onMouseDown = this.onMouseDownFn.bind(this);
        this.onMouseUp = this.onMouseUpFn.bind(this);
        this.onTouchStart = this.onTouchStartFn.bind(this);
        this.onTouchEnd = this.onTouchEndFn.bind(this);
        this.onContextMenu = this.onContextMenuFn.bind(this);
      ...
      initPasses() {
        // Skip EffectComposer—render directly to avoid postprocessing issues
      }
      ...
      setSizeFn(width: number, height: number, _updateStyles?: boolean) {
        if (width <= 0 || height <= 0) {
          this.hasValidSize = false;
          return;
        }
