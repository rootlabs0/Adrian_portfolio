  ...
  return (
    ...
    >
      <div className="py-10 md:py-40 w-full relative" style={{ perspective: "1000px" }}>
        ...
        <ScrollCard rotate={rotate} translate={translate} scale={scale} scrollYProgress={scrollYProgress}>
          {children}
        </ScrollCard>
      </div>
    </div>
...
export const ScrollCard = ({
  ...
  >
    <motion.div style={{ opacity }} className="h-full w-full overflow-hidden rounded-2xl bg-zinc-900">
      {children}
    </motion.div>
  </motion.div>
);
